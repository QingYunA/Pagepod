...
export const translations = {
  zh: {
    ...
    gallery: {
      ...
      dismissNotice: "关闭提示",
      previewActionTip: "点击立即运行沙箱，或悬停蓄力预览",
      openInNewTabTip: "在新标签页打开",
      loadMore: "加载更多项目",
      runOnline: "在线运行",
    },
    footer: {
    ...
    runner: {
      ...
      privateBadge: "私有项目",
      unlistedBadge: "口令保护",
      statusPrivateOwner: "私有 (所有者可访问)",
      statusPrivate: "私有保护",
      statusUnlisted: "未公开 (口令保护)",
      ...
      copyEmbed: "复制嵌入代码",
      embedSandboxNotice: "包含安全沙箱隔离参数，可安全嵌入任意站点",
      relatedTitle: "相关作品推荐",
  ...
  en: {
    ...
    gallery: {
      ...
      previewActionTip: "Click to run sandbox, or hover to preview",
      openInNewTabTip: "Open in new tab",
      loadMore: "Load More",
      runOnline: "Run online",
    },
    footer: {
    ...
    runner: {
      ...
      unlistedBadge: "Token Protected",
      statusPrivateOwner: "Private (Owner Accessible)",
      statusPrivate: "Private Protected",
      statusUnlisted: "Unlisted (Token Protected)",
      ...
      embedSandboxNotice: "Includes sandbox isolation attributes for secure embedding",
