...
- **游客认领与客户端暂存**：[`src/lib/storage/guest-claim.ts`](file:///Users/mac/.gemini/antigravity/worktrees/html-manager/claim_guest_html_uploads/src/lib/storage/guest-claim.ts)
